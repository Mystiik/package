...
function add_member() {
  ...
  member.innerHTML = '<div class="card"><div class="d-flex flex-wrap card-body"><div class="col-12 p-2"><label class="form-label">Aperçu</label><img class="object-fit-cover img-team m-auto mt-2" name="img" src=""></div><div class="col-12 p-2"><label class="form-label">Image ID</label><input class="form-control" type="text" name="imageId" maxlength="50" onchange="update_image_id(this);" value=""></div><div class="col-12 p-2"><label class="form-label">Prénom NOM</label><input class="form-control" type="text" name="name" maxlength="50" value=""></div><div class="col-12 p-2"><label class="form-label">Fonction</label><input class="form-control" type="text" name="function" maxlength="50" value=""></div><div class="d-flex flex-flow-wrap m-3" style="position: absolute; right: 0; top: 0; justify-content: flex-end;"><input class="form-control p-0 text-center mr-1" style="width: 20%;" type="text" name="order" onchange="update_id(this);" value=""><button class="btn-close" onclick="remove_member(this);"></button></div></div></div>';
